...
* [10. 其他设计、术语及参考资料](#10-其他设计术语及参考资料)
    * [参考资料](#参考资料)
* [优势与特色：](#优势与特色)
...
你会注意到，当webdriver.Firefox()被调用时，FireFox浏览器启动了。对值webdriver.Firefox()调用type()，揭示它具有WebDriver数据类型。调用brower.get(‘http://www.amazon.com’)将浏览器指向
